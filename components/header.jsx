...
const Header = () => {
  ...
  return (
    <section       
    id="home" className="flex lg:flex-row flex-col-reverse gap-y-12 justify-center lg:justify-between items-center">
      <div className="relative lg:w-[55%] w-full flex justify-center items-center gap-y-5 flex-col">
        ...
        <p className="text-lg">and I am a Full Stack Developer</p>
        <a
          href="/resume.pdf"
          download
          className="mx-auto z-20 w-max hover:-translate-y-2 transition-all p-3 rounded-md bg-green-600 border-none"
        >
          My Resume
        </a>
